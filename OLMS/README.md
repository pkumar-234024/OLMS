...
To update the database use this command from the Web project folder (replace `OLMS` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../OLMS.Infrastructure/OLMS.Infrastructure.csproj -s OLMS.Web.csproj
```
